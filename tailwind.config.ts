  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        "soft-cream": {
          DEFAULT: "var(--soft-cream)",
          50: "#fefce8", // Main soft-cream
          100: "#fef9c3",
          200: "#fef08a",
          300: "#fde047",
          400: "#facc15",
      ...
      boxShadow: {
        spiritual: "0 4px 12px rgba(30, 64, 175, 0.15)",
        warm: "0 4px 12px rgba(245, 158, 11, 0.15)",
        sage: "0 4px 12px rgba(16, 185, 129, 0.15)",
        "spiritual-lg": "0 8px 25px rgba(30, 64, 175, 0.2)",
        "warm-lg": "0 8px 25px rgba(245, 158, 11, 0.2)",
        "sage-lg": "0 8px 25px rgba(16, 185, 129, 0.2)",
      },
      backdropBlur: {
        xs: "2px",
      },
